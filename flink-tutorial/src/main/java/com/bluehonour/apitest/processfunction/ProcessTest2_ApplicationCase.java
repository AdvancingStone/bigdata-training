package com.bluehonour.apitest.processfunction;
...
public class ProcessTest2_ApplicationCase {
    ...
    public static class TempConsIncreWarning extends KeyedProcessFunction<Tuple, SensorReading, String> {
        ...
        public void processElement(SensorReading value, Context ctx, Collector<String> out) throws Exception {
            ...
            System.out.println("lastTemp: " + lastTemp + "\tcurTemp: " + value.getTemperature());
            System.out.println("lastTimerTs: " + timerTs + "\tcurTimerTs: " + value.getTimestamp());
